...
authRouter.post('/change-password', isAuthenticated,ResetPasswordController.changePassword);
authRouter.post('/reset-password/:token', ResetPasswordController.resetPassword);
